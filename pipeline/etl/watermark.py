...
def read_watermark(client, src_tbl:str) -> str | None:
    sql = f"""
    ...
    job_config = bigquery.QueryJobConfig(
        query_parameters=[
            bigquery.ScalarQueryParameter("table_name", "STRING", src_tbl),
        ]
    )
...
def update_watermark(client, src_tbl:str, watermark:str) -> None:
    sql = f"""
